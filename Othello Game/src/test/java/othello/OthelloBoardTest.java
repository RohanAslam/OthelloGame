...
public class OthelloBoardTest {
    ...
    public void testFlip() {
        String testBoardString = "  " +
                ...
                " +-+-+-+-+-+-+-+-+\n" +
                "  0 1 2 3 4 5 6 7 \n";
        board.flip(2,2, 0,1, OthelloBoard.P1);
        assertEquals(testBoardString,board.toString());
    }

    @Test
    public void testOthelloBoardCopy() {
        OthelloBoard testBoard = new OthelloBoard(8);
        testBoard.othelloBoardCopy(board);
